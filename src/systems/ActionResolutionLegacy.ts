...
/**
 * ActionResolutionLegacy orchestrates the complete action execution flow:
 ...
 *
 * This is the legacy version used before the async BattleAdapter refactor.
 * See ActionResolution for the new async version.
 */
export class ActionResolutionLegacy {
